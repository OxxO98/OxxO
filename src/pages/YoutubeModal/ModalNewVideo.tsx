...
interface ModalVideoContainerProps {
  fetch : () => void;
  handleClose? : () => void;
}

const ModalNewVideo = ({ fetch } : ModalNewVideoProps ) => {
    ...
    <>
      <Modal>
        ...
        <Modal.Wrap>
          ...
          <Modal.Body>
            <ModalVideoContainer fetch={fetch}/>
          </Modal.Body>
          <Modal.Footer>
            <Modal.CloseButton>
              <button>닫기</button>
...
const ModalVideoContainer = ({ fetch, ...props } : ModalVideoContainerProps ) => {
