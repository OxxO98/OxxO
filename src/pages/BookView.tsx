...
const BookView = ({ navRoute, changeRoute, rowLength, pageLength } : BookViewProps ) => {
  ...
  const { selection, hurigana, offset, selectedBun, textOffset } = useHandleSelection( document, "activeRange" );
  ...
  const handleTangochouScroll = (e : React.WheelEvent) => {
    if(e.deltaY > 0){
