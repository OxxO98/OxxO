    ...
    switch (navRoute) {
        ...
        case 'Hon':
            return ((0, jsx_runtime_1.jsxs)("div", { className: "hon-page-layout", children: [(0, jsx_runtime_1.jsxs)("div", { className: `hon-layout ${edit === true ? 'editing' : ''}`, children: [isMobile &&
                                ...
                                (0, jsx_runtime_1.jsx)("div", { className: `hon ${isClicked}`, id: `${edit === false ? "activeRange" : ""}`, children: (0, jsx_runtime_1.jsx)(pages_1.Hon, { page: page, rowLength: rowLength, pageLength: pageLength, bIdRef: bIdRef, styled: styled, setScroll: setScrollHon }) }), (0, jsx_runtime_1.jsx)(customComp_1.HonGrantWrapper, { restrict: 'ADMIN', children: edit === true &&
