...
interface AudioWaveCompProps {
  ...
  filteredData : FilteredDataObj
  setFilteredData : ( filteredData : FilteredDataObj ) => void;
}

const AudioWaveComp = ({ audioData, audioError, videoId, videoTime, duration, frameRate, gotoTime, startTime, endTime, setStartTime, setEndTime, autoStop, playing, selectMarker, filteredData, setFilteredData } : AudioWaveCompProps ) => {
  ...
  const setRangeCrit = (time : number, zoom : number) => {
