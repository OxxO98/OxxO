...
const LogInComp = ({ setRoute, changeRoute, setUserName }) => {
    ...
    return ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsxs)("div", { className: "Login", children: [(0, jsx_runtime_1.jsxs)("div", { className: "Login_input_container", children: [(0, jsx_runtime_1.jsx)("div", { className: "container_flexEnd", children: (0, jsx_runtime_1.jsx)("input", { className: "id", name: "id", placeholder: "username", onChange: handleChange }) }), (0, jsx_runtime_1.jsx)("div", { className: "container_flexEnd", children: (0, jsx_runtime_1.jsx)("input", { className: "password", type: "password", name: "password", placeholder: "password", onChange: handleChange }) })] }), (0, jsx_runtime_1.jsxs)("div", { className: "Login_button_container", children: [(0, jsx_runtime_1.jsx)("div", { className: "button-container_flexEnd", children: (0, jsx_runtime_1.jsx)("button", { className: "button_flex-grow button-positive", onClick: logIn, children: "\uB85C\uADF8\uC778" }) }), (0, jsx_runtime_1.jsx)("div", { className: "button-container_flexEnd", children: (0, jsx_runtime_1.jsx)("button", { className: "button_flex-grow button-neutral", onClick: guestLogIn, children: "\uAC8C\uC2A4\uD2B8 \uC544\uC774\uB514\uB85C \uB85C\uADF8\uC778" }) }), (0, jsx_runtime_1.jsx)("div", { className: "button-container_flexEnd", children: (0, jsx_runtime_1.jsx)("button", { className: "button_flex-grow button-neutral", onClick: () => setRoute('signUp'), children: "\uD68C\uC6D0\uAC00\uC785" }) })] })] }) }));
};
const SignUpComp = ({ setRoute }) => {
    ...
    return ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsxs)("div", { className: "Login", children: [(0, jsx_runtime_1.jsxs)("div", { className: "Login_input_container", children: [(0, jsx_runtime_1.jsxs)("div", { className: "button-container_flexEnd", children: [(0, jsx_runtime_1.jsx)("input", { className: "input_flex", name: "id", placeholder: "username", onChange: handleChange }), (0, jsx_runtime_1.jsx)("button", { className: "button-positive", onClick: validateId, children: "\uC911\uBCF5 \uD655\uC778" })] }), isIdValidate !== null && isIdValidate === false &&
