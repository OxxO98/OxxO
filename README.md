...
등록된 단어를 모아서 한 곳에서 볼 수 있습니다. 단어장에는 해당 단어가 등록된 문장, 번역을 볼 수 있습니다. 또한 해당 단어에 여러 표기가 등록된 경우는 구분해서 보여줍니다.

![단어장](readme_img/Tangochou.gif)

단어장을 검색할 수 있습니다. 읽기로도 검색가능합니다. 단어의 한자를 클릭하면 해당 한자가 포함된 단어가 표시되며, 클릭 시 각 단어로 이동가능합니다.
